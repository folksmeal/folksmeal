    ...
    return (
        <main className="min-h-screen bg-black text-white selection:bg-emerald-500/30">
            ...
            <div className="pt-32 pb-24 container mx-auto px-6 md:px-12 max-w-4xl">
                <h1 className="text-4xl md:text-5xl font-bold text-[#d5d5d5] mb-8">Terms of Service</h1>
                ...
                <div className="space-y-8 text-[#d5d5d5]/80 leading-relaxed">
                    ...
                    <section className="space-y-4">
                        <h2 className="text-2xl font-semibold text-white">4. Ordering and Payment</h2>
                        <ul className="list-disc pl-6 space-y-2">
                    ...
                    <section className="space-y-4">
                        <h2 className="text-2xl font-semibold text-white">5. Cancellation and Refunds</h2>
                        <p>
                    ...
                    <section className="space-y-4">
                        ...
                        <p className="font-medium text-white">support@folksmeal.com</p>
                    </section>
                </div>
            </div>
