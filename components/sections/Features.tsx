...
import { Smartphone, ShieldCheck, Utensils, BarChart2, Leaf } from "lucide-react";
                        ...
                        >
                            ...
                            <div className="relative w-14 h-14 rounded-xl bg-gradient-to-br from-orange-500/20 to-red-500/20 border border-orange-500/30 flex items-center justify-center backdrop-blur-sm shadow-[0_8px_32px_rgba(249,115,22,0.15)]">
                                ...
                                <motion.div
                                    ...
                                    className="absolute -top-1 -right-1 w-4 h-4 rounded-full bg-green-500 border-2 border-[#08090a] flex items-center justify-center"
                                >
        ...
        header: (
            <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-gradient-to-br from-blue-500/5 to-cyan-500/5 border border-blue-500/10 flex items-center justify-center relative overflow-hidden">
                ...
                >
                    ...
                    <motion.div
                        animate={{ rotateX: 12 }}
                        className="absolute inset-0 bg-[#08090a]/90 border border-blue-500/30 rounded-lg flex flex-col gap-1.5 p-2 shadow-2xl"
                    >
                        <motion.div
...
export function Features() {
    return (
        <section id="features" className="py-24 bg-[#08090a]">
                ...
                <BentoGrid className="max-w-7xl mx-auto">
                    {features.map((item, i) => (
                        <BentoGridItem
                            ...
                            header={item.header}
                            icon={item.icon}
                            className={`${item.className} bg-[#d5d5d5]/5 border-[#d5d5d5]/10 hover:bg-[#d5d5d5]/10 transition-colors`}
                        />
                    ))}
                </BentoGrid>
            </div>
