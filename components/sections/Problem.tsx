        ...
        <section id="problem" className="py-24 bg-white relative overflow-hidden">
            <div className="container mx-auto px-6 md:px-12">
                <div className="text-center mb-16">
                    ...
                    >
                        The Hidden Cost of Unmanaged Meals
                    </motion.h2>
                    <motion.p
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {problems.map((problem, index) => (
                        <motion.div
                            ...
                            className="group p-8 rounded-2xl bg-slate-50 border border-primary/20 hover:bg-hover-bg hover:shadow-md transition-[background-color,border-color,box-shadow] duration-500 cursor-pointer"
                        >
